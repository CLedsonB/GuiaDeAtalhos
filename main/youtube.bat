...
goto INICIO
setlocal
rem set caminho=../error
rem set nomeArquivo=num.bat
...
if errorlevel 8 call index.bat && exit
...
if %opc% gtr 7 cd ../error && start num.bat && timeout 3 && start youtube.bat
if %opc% lss O cd ../error && start num.bat && timeout 3 && start youtube.bat
